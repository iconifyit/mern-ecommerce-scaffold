...
import * as family from './containers/Family/actions';
import * as set from './containers/Set/actions';
...
import * as credit from './containers/Credit/actions';
import * as transaction from './containers/Transaction/actions';

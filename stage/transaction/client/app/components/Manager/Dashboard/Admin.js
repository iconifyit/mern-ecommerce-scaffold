            ...
            <Row>
                ...
                <div className='panel-body'>
                    <Switch>
                        ...
                        <Route path='/dashboard/family' component={Family} />
                        <Route path='/dashboard/set' component={Set} />
                        ...
                        <Route path='/dashboard/credit' component={
                            Credit
                        } />
                        <Route path='/dashboard/transaction' component={
                            Transaction
                        } />
